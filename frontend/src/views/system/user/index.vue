        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="用户密码" prop="password" :rules="pwdValidator">
              <el-input v-model="form.password" placeholder="请输入用户密码" type="password" maxlength="72" show-password />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
@media (max-width: 767px) {
  .content-inner { padding: 12px !important; }
  :deep(.el-form--inline .el-form-item) { width: 100% !important; margin-right: 0; }
  :deep(.el-form--inline .el-form-item__content) { min-width: 0; }
